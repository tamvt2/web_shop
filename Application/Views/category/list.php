...
<head>
    ...
    <title>Pos Coron - Category List</title>
										...
										if (isset($values) && !empty($values)) {
											foreach($values as $value) {
												echo '<tr>
													...
													<td>'.$value['name'].'</td>
													<td>
														<a type="button" class="btn btn-warning btn-sm mb-1" href="/update-category/'.$value['category_id'].'">Sửa</a>
														<a type="button" class="btn btn-danger btn-sm" onclick="removeRow('.$value['category_id'].', \'/destroy-category/\')">Xóa</a>
													</td>
												</tr>';
											}
										}
